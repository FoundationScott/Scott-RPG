...
1. Python: The Game requires Python to be installed on your computer. To install Python, please follow these steps:

1a. Visit 'https://www.python.org/downloads/' and download the latest version. During installation, ensure that you select the 'Add To PATH' option, which allows you to run 'pip' commands. 

2. Cryptography: Cryptography is necessary for save files to work in the Game. To install Cryptography, follow these steps:

2a. Open your Windows command prompt (cmd). Type 'pip install cryptography' and press Enter. After the installation is complete, verify the version by typing 'pip show cryptography'. If the version is '41.0.4' or above, Cryptography has been successfully installed. 
...
User Agreement Last Updated: Friday, October 13, 2023
