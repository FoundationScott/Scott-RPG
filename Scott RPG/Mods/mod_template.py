...
# READ ME: All functions below are examples of how to mod, please note that if you want to mod you must keep function names the same
...
add_shield({"Shield Name": Shield("", "Shield Name", 10, 10, 10, 1)})
...
add_armor({"Helmet Name": Armor("", "Helmet Name", 3, 5, 0, 0, 1, 3000, "Helmet")}, 
          {"Chestplate Name": Armor("", "Chestplate Name", 3, 5, 0, 0, 1, 3000, "Chestplate")}, 
          {"Leggings Name": Armor("", "Leggings Name", 3, 5, 0, 0, 1, 3000, "Leggings")}, 
          {"Boots Name": Armor("", "Boots Name", 3, 5, 0, 0, 1, 3000, "Boots")})
